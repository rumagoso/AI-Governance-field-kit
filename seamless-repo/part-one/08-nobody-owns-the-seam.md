...
The scale can be much larger than one utility's infrastructure boundary. In 2023, a single undetected zero-day in the MOVEit file-transfer software, a vendor product sitting in workflows nobody was watching closely enough, led to breaches at more than 2,700 organisations and over ten billion dollars in remediation costs across sectors. None of those organisations had deployed a rogue AI agent. The seam was a vendor relationship, decades old as a category of risk, and it still took down thousands of downstream victims because the same ownership ambiguity applied: the software was inside the perimeter, trusted, and nobody's job description included watching it continuously.
...
*See it filled in: Ondas Digital maps the seam in its own client chatbot in Chapter 8.*
